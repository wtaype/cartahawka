import{$ as d,r as _,g as C,a as b,q as f,c as v,d as g,l as y,s as S}from"./widev-dFYhDOSz.js";/* empty css              */import"./wiauth-xx9dWMjy.js";const $=()=>d(".webz").each((s,n)=>{const i=d(n);i.find(".webx").css("height",i.find(".weby").outerHeight())}),j=(()=>{let s;return()=>(clearTimeout(s),s=setTimeout($,120))})();d(j);d(window).on("load resize orientationchange",j);const o={COL_CARTAS:"cartasdb",COL_HOJAS:"hojasdb",C_CARTAS:"cartasdbCachePublic",C_HOJAS:"hojasdbCachePublic",HRS:6,LIM_CARTAS:500,LIM_HOJAS:50,IMG_FALLBACK:"https://i.postimg.cc/KvN8qF2P/menu-default.jpg"},O=s=>s==null||s===""?"":`S/${Number(s).toFixed(2)}`,L=(s,n,i)=>{const a=i[s]||{},r=a.nota?`<p class="menu-note"><i class="fas fa-info-circle"></i> ${a.nota}</p>`:"",l=a.imagen||o.IMG_FALLBACK,m=n.map(c=>`
    <div class="menu-item">
