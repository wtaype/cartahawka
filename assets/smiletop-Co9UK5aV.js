import{o as g,e as b,$ as i,b as y,M as n,k as e,a as d,c as u,d as m,F as $,f as w,m as A}from"./widev-dFYhDOSz.js";/* empty css              */g(b,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const h=`
