import{o as g,b,$ as i,f as y,M as n,F as o,c as d,e as u,d as m,G as $,n as w,p as A}from"./widev-CrCufw-x.js";g(b,async r=>{r?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(b),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(r){console.error(r)}});async function S(r){const h=`
