import{o as g,e as h,$ as i,f as y,M as n,t as e,a as d,c as u,d as m,E as $,h as w,k as A}from"./widev-CRmnv79V.js";/* empty css              */g(h,async l=>{l?S():window.location.href="/"});i(".logout-btn").click(async()=>{try{await y(h),n("Sesión cerrada correctamente","success"),window.location.href="/"}catch(l){console.error(l)}});async function S(l){const b=`
